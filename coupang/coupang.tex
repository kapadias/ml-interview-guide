...
\begin{center}\includegraphics[width=\linewidth]{figures/funnel.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/latency.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/two-tower.pdf}\end{center}
...
\begin{decide}{Which contrastive objective?}
\drow{CHOSE}{Sampled softmax / InfoNCE over the candidate set}
\drow{OVER}{Triplet loss with a margin, or BPR}
\drow{WHY}{the softmax normalises over many negatives at once, so the gradient is informed by the whole candidate set and directly optimises the ranking you serve. Triplet sees one negative at a time, needs margin tuning and semi-hard mining, and collapses if you get either wrong.}
\drow{COST}{large batches to get enough negatives, and a temperature that genuinely needs tuning}
\end{decide}
...
\begin{center}\includegraphics[width=\linewidth]{figures/negatives.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/esmm.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/skew.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/surfaces.pdf}\end{center}
...
\begin{center}\includegraphics[width=\linewidth]{figures/seam.pdf}\end{center}
