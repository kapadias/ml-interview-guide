...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 9. Recalibrating after negative downsampling.\par}\medskip
...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 10. Why LambdaRank exists, and what the lambda is.\par}\medskip
...
\begin{Verbatim}[fontsize=\small,xleftmargin=4pt,samepage=false]
    ...
    +----+------+                       +-------+--------+
         ...
         +------------------+-------------------+
                     ...
                     +--------------+     the product above.
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 11. ESMM. The CVR tower has no loss of its own.\par}\medskip
...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 12. Multi-task L2 ranker.\par}\medskip
...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 13. Log-and-train removes skew by construction.\par}\medskip
...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 14. The same query, two surfaces.\par}\medskip
...
\end{Verbatim}
\nopagebreak{\footnotesize\color{muted}Figure 15. The coupling. Each stage is trained on the other's output.\par}\medskip
