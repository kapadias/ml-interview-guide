...
\begin{itemize}
    ...
    \item \badgeLseven{L7} Reasons about second-order effects---e.g., admission control causing queue buildup and cascading latency, KV offloading interacting poorly with speculative decoding, and when the right answer is to switch to a GQA model rather than patching the serving stack.
\end{itemize}
