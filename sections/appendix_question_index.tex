...
\quad L5 (Senior Engineer) & 88 \\
\quad L6 (Staff Engineer) & 127 \\
\quad L7 (Principal Engineer) & 33 \\
\midrule
...
\quad Estimation & 31 \\
\quad Debugging & 42 \\
\quad Architecture Design & 46 \\
\quad First Principles & 19 \\
\midrule
...
88 questions. These test solid fundamentals, clear communication, and the ability to compare approaches.
...
33 questions. These test architectural vision, systems thinking, novel problem decomposition, and second-order effects.
...
33 & RAG works for factual queries but fails for reasoning queries. Diagnose. \freqlow & \ref{chap:long_context_rag} & Debugging \\
\end{longtable}
...
49 questions testing understanding of \textit{what} and \textit{why} --- definitions, mechanisms, and design rationale.
...
61 questions testing the ability to \textit{compare} approaches and articulate when to choose one over another.
...
31 questions testing back-of-envelope calculation, numerical fluency, and system sizing.
...
29 & Throughput (tokens/sec): 70B on 8$\times$H100s. & \ref{chap:inference_optimization} & L7 \\
30 & 500 concurrent users, 2s TTFT---infrastructure sizing. & \ref{chap:inference_optimization} & L7 \\
31 & Cost per query: RAG vs long-context LLM (128K). & \ref{chap:long_context_rag} & L6 \\
\end{longtable}

\subsection{Debugging Questions}

42 questions testing systematic diagnosis of training, serving, and data pipeline failures.
...
39 & INT4 quantized model: garbage on some prompts, fine on others. & \ref{chap:inference_optimization} & L6 \\
40 & Speculative decoding slower than standard. & \ref{chap:inference_optimization} & L6 \\
41 & RAG returns relevant docs but LLM ignores them. & \ref{chap:long_context_rag} & L6 \\
42 & RAG works for factual queries, fails for reasoning queries. & \ref{chap:long_context_rag} & L7 \\
\end{longtable}

\subsection{Architecture Design Questions}

46 questions testing end-to-end system design, from problem formulation to production deployment.
...
44 & Red teaming program for LLM product. & \ref{chap:safety_alignment} & L6 \\
45 & Enterprise doc Q\&A RAG over 10M documents. & \ref{chap:long_context_rag} & L6 \\
46 & RAG for legal document search platform. & \ref{chap:long_context_rag} & L7 \\
\end{longtable}

\subsection{First Principles Questions}

19 questions testing the ability to \textit{derive} results, explain \textit{why} something works from mathematical or theoretical foundations.
...
Attention \& Transformers & Ch~\ref{chap:attention_transformers} & 17 \\
...
\textit{The most heavily tested topic area in 2026 interviews.}
