...
An embedding is a learned mapping $f: \mathcal{X} \to \R^d$ from a discrete or high-dimensional space to a lower-dimensional continuous vector space where geometric relationships encode semantic similarity.
\end{definition}
...
\begin{definition}[Embedding Collapse]
When embeddings converge to a low-dimensional subspace or constant vector, losing representational capacity.
\end{definition}
