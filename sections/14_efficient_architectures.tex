...
Typical choices in the 2023-era designs covered here: $N_{experts} = 8\text{--}64$, $k = 1\text{--}2$ (newer fine-grained MoEs push to far higher expert counts with larger $k$). The router is a simple linear layer---complexity is in the load balancing, not the routing itself.
