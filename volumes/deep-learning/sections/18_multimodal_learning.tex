...
\begin{tikzpicture}[
    node distance=0.5cm,
    box/.style={rectangle, draw, rounded corners=3pt, minimum width=2.1cm, minimum height=0.7cm, align=center, font=\small},
    ...
    \node[encoder] (ea) at (-1.15, 2.5) {Image};
    \node[encoder] (eb) at (1.15, 2.5) {Text};
    ...
    \node[encoder] (la) at (3.85, 2.5) {Image Enc.};
    \node[encoder] (lb) at (6.15, 2.5) {Text Enc.};
    \node[encoder] (la2) at (3.85, 1.5) {$\mathbf{z}_{\text{img}}$};
    \node[encoder] (lb2) at (6.15, 1.5) {$\mathbf{z}_{\text{txt}}$};
    ...
    \node[encoder] (ca) at (9.05, 2.5) {Image Enc.};
    \node[encoder] (cb) at (11.35, 2.5) {Text Enc.};
