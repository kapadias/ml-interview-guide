...
\begin{tikzpicture}[
    ...
    \node[right=0.5cm of dp, fill=red!20, draw, rounded corners] (dn) {$d_- = d(\vz_a, \vz_n)$};
...
\begin{tikzpicture}[scale=1.5,
    ...
    lead/.style={gray, thin}
]
    % Bands first, so every annotation below is drawn on top of them
    \draw[green!70!black, thick] (0,0) circle (0.9);
    \draw[orange, thick, dashed] (0,0) circle (1.5);
    \draw[red, thick] (0,0) circle (2.1);

    % Anchor, positive and hard negative all sit inside the positive radius
    \fill[blue] (0,0) circle (2.5pt);
    \node[lbl, text=blue, right=2pt] at (0,0) {Anchor};
    \fill[green!70!black] (0,0.9) circle (2pt);
    \node[lbl, text=green!70!black, above=2pt] at (0,0.9) {Positive};
    \fill[red!70!black] (-0.55,-0.45) circle (2pt);
    \node[lbl, text=red!70!black, right=2pt] at (-0.55,-0.45) {Hard neg};

    % The two negatives beyond the positive radius are called out past the outer circle
    \fill[orange] (1.2,0.35) circle (2pt);
    \draw[lead] (1.2,0.35) -- (2.5,0.95);
    \node[lbl, text=orange, right] at (2.5,0.95) {Semi-hard neg};
    \fill[gray] (1.35,-1.35) circle (2pt);
    \draw[lead] (1.35,-1.35) -- (2.5,-1.55);
    \node[lbl, text=gray, right] at (2.5,-1.55) {Easy neg};

    % Each radius labelled on the circle it names
    \node[lbl] at (-0.31,-0.84) {$d(a,p)$};
    \node[lbl] at (-0.52,-1.41) {$d(a,p)+m$};

    % Legend
    \draw[green!70!black, thick] (2.5, 0.2) -- (3.0, 0.2) node[right, font=\footnotesize] {Positive radius};
    \draw[orange, thick, dashed] (2.5, -0.3) -- (3.0, -0.3) node[right, font=\footnotesize] {Margin boundary};
\end{tikzpicture}
