...
\begin{tikzpicture}[
    ...
    % Edges
    \draw[arrow] (input) -- node[above, font=\tiny, align=center] {random\\75\% mask} (visible);
    \draw[arrow] (visible) -- (enc);
    \draw[arrow] (enc) -- (masktok);
    \draw[arrow] (masktok) -- (dec);
    \draw[arrow] (dec) -- node[above, font=\tiny, align=center] {MSE on masked\\patches only} (recon);
