...
\begin{itemize}
    ...
    \item Caveat: in-batch negatives are drawn in proportion to item popularity, which systematically over-penalizes popular items on skewed catalogs; the standard fix is the logQ correction (subtract $\log Q(\text{item})$, the item's sampling probability, from its logit; Yi et al., 2019)
