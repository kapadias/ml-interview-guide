...
demonstrated this).
(3)~\textbf{LoRA-appropriate learning rate} ($1\text{e-}4$ to $3\text{e-}4$,
roughly $10\times$ the full fine-tuning rate, because only the small adapter
matrices are being trained) with cosine schedule and warmup.
