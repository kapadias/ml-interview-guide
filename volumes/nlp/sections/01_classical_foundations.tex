...
Chapter~\ref{chap:statistical_nlp}. For this chapter's narrative, the essential point is
that n-gram models formalized the insight that local word context carries predictive
signal, and their limitations (data sparsity, no generalization across semantically
similar words) motivated the neural language models that followed.
